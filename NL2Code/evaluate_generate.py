...
if(args.is_lexicon==1):
  df.fillna("",inplace=True)
  X = "NL2CODE\nNL:"+df["nl"]+"\nPK:"+df["parking"]
elif(args.is_lexicon==2):
  X = "NL2CODE\nNL:"+df["nl"]+"\nPAIRS:"+df["parking_pairs"]
elif(args.is_lexicon==3):
  X = "NL2CODE\nNL:"+df["nl"]+"\nPAIRS:"+df["pair_retrieved"]
else:
  X = "NL2CODE\nNL:"+df["nl"]
...
elif("NLFL" in filename or "docs" in filename or "exprompting" in filename):
